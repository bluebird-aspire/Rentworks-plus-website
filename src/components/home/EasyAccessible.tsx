        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F4F5F7] rounded-2xl p-10 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              New agents can learn essential tasks in hours, not weeks. Guided flows, smart
              defaults, and inline tips reduce training time by up to 50%.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#007A55] to-[#006644] rounded-2xl p-10 text-white hover:shadow-xl transition-all relative overflow-hidden">
            ...
            <p className="text-white/90 text-lg leading-relaxed mb-8">
              Full car rental system in your browser. Works on modern desktop and laptop devices.
              Fully responsive interface on tablets and phones. Perform check-in/check-out and
              inspections on the go. Real-time updates across all devices.
            </p>
