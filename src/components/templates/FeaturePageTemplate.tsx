        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-left">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">{hero.subtitle}</p>
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  href="/"
                  className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl transition-all duration-300 border-2 border-white/20 flex items-center"
                >
                  Learn More
                </Link>
              </div>
