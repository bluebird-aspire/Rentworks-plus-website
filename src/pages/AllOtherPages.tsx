    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-left">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-8">{hero.subtitle}</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-[#081E32] mb-6 text-3xl lg:text-4xl font-semibold">
            {audienceAlignment.title}
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {audienceAlignment.priorities.map((priority, index) => (
              <div
                key={index}
                className="bg-[#F4F5F7] rounded-xl p-6 hover:shadow-lg transition-shadow"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {strengths.map((strength, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#007A55] hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {useCases.map((useCase, index) => (
              <div
                key={index}
                className="bg-[#F4F5F7] rounded-xl p-8 hover:-translate-y-2 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {intelligence.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 border-2 border-[#007A55] shadow-lg"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-6">
            {metrics.map((metric, index) => (
              ...
              >
                <div className="text-4xl font-bold text-[#007A55] mb-2 animate-pulse-metric">
                  {metric.metric}
                </div>
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Franchise and multi-location operators need consistency, visibility, and control. RentWorksPlus+ centralizes operations with synchronized pricing, fleet availability, and performance insights—across every branch.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          title: 'Fleet Visibility Across Branches',
          description:
            'See fleet availability for all branches in one unified view with drag-and-drop allocation.',
        },
        {
          title: 'Auto-Transfer Vehicles',
          description:
            'AI recommends vehicle transfers based on demand forecasts and booking patterns.',
        },
        {
          title: 'Align Pricing Across Regions',
          description:
            'Set base pricing centrally while allowing local market adjustments within guidelines.',
        },
        {
          title: 'Compare Branch Performance',
          description:
            'Revenue, utilization & KPIs per location with actionable improvement recommendations.',
        },
        {
          title: 'Franchise Compliance Monitoring',
          description:
            'Track adherence to brand standards, pricing rules, and operational guidelines.',
        },
        {
          title: 'Centralized Customer Service',
          description:
            'Handle customer inquiries and reservations for any branch from central operations.',
        },
      ]}
      intelligence={[
        {
          title: 'AI Fleet Transfer Recommendations',
          description:
            'Machine learning analyzes booking patterns and suggests optimal vehicle transfers between branches to maximize network-wide utilization.',
        },
        {
          title: 'Dynamic Rate Adjustments Per Market',
          description:
            'Smart pricing engine adapts rates based on local competition, seasonality, and demand while maintaining brand consistency.',
        },
        {
          title: 'Franchise-Wide KPI Visualization',
          description:
            'Executive dashboards with drill-down capabilities show performance trends, outliers, and opportunities across your entire network.',
        },
      ]}
      metrics={[
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Corporate mobility depends on accuracy, lifecycle visibility, and billing efficiency. RentWorksPlus+ simplifies long-term leases, contract renewals, and cost-center billing with intelligent automation.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          ...
          description:
            'Automated billing based on contract terms with itemized cost center allocation and approval workflows.',
        },
        {
          title: 'Allocate Vehicles to Departments',
          description:
            'Assign vehicles to specific departments or employees with usage tracking and cost attribution.',
        },
        {
          title: 'Track High-Mileage Vehicles',
          description:
            'Monitor vehicle mileage and service needs with automated maintenance scheduling alerts.',
        },
        {
          title: 'Manage Long-Term Renewals',
          description:
            'Proactive renewal notifications with contract performance analytics and optimization suggestions.',
        },
        {
          title: 'Corporate Portal Access',
          description:
            'Self-service portal for employees to request vehicles, track usage, and manage bookings.',
        },
        {
          title: 'Fleet Lifecycle Analytics',
          description:
            'Total cost of ownership tracking per vehicle with optimal replacement timing recommendations.',
        },
      ]}
      intelligence={[
        {
          title: 'Renewal Likelihood Scoring',
          description:
            'AI analyzes utilization patterns, satisfaction indicators, and contract performance to predict renewal probability and suggest retention strategies.',
        },
        {
          title: 'Contract Profitability Insights',
          description:
            'Machine learning evaluates contract performance against operational costs to identify profitable segments and optimization opportunities.',
        },
        {
          title: 'Lifecycle Cost Forecasting',
          description:
            'Predictive analytics forecast maintenance, depreciation, and operational costs to optimize fleet composition and replacement timing.',
        },
      ]}
      metrics={[
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Commercial rentals involve high-mileage vehicles, complex contracts, and increased service demands. RentWorksPlus+ provides precision tools for reliability, turnover speed, and asset profitability.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          title: 'Track Maintenance for Heavy-Use Vehicles',
          description:
            'Schedule service based on engine hours, mileage, and usage intensity with automated vendor coordination.',
        },
        {
          title: 'Create Multi-Vehicle Contracts',
          description:
            'Rent entire fleets to commercial customers with volume pricing and coordinated delivery schedules.',
        },
        {
          title: 'Capture High-Resolution Condition Reports',
          description:
            'Document vehicle condition with timestamped photos, videos, and damage annotations for dispute resolution.',
        },
        {
          title: 'Apply Use-Based Pricing',
          description:
            'Flexible pricing models based on mileage, operating hours, geographic zones, or payload capacity.',
        },
        {
          title: 'Commercial Customer Management',
          description:
            'Dedicated portals for commercial accounts with credit terms, purchase orders, and bulk reservations.',
        },
        {
          title: 'Asset Utilization Optimization',
          description:
            'Track commercial vehicle ROI with detailed cost per rental hour and profitability analytics.',
        },
      ]}
      intelligence={[
        {
          ...
          description:
            'AI predicts upcoming service needs and costs based on vehicle age, mileage, and historical maintenance patterns to optimize budget planning.',
        },
        {
          title: 'Commercial Fleet Heatmaps',
          description:
            'Visualize demand patterns, utilization hotspots, and underperforming assets to guide fleet composition and deployment strategies.',
        },
        {
          title: 'AI Inspection Comparison',
          description:
            'Computer vision automatically detects new damage by comparing pre and post-rental photos, reducing disputes and streamlining turnover.',
        },
      ]}
      metrics={[
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Electric and micro-mobility fleets require charging-aware insights, rapid turnover, and agile operations. RentWorksPlus+ delivers real-time battery intelligence, routing visibility, and AI optimization.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          title: 'Notify Staff When Units Need Charging',
          description:
            'Automated alerts when battery levels reach thresholds with optimal charging location recommendations.',
        },
        {
          title: 'Track Distribution Hotspots',
          description:
            'Real-time heatmaps show where vehicles are being picked up and dropped off to guide rebalancing.',
        },
        {
          title: 'Optimize Vehicle Placement for Demand',
          description:
            'AI predicts demand patterns and suggests strategic pre-positioning of vehicles to high-traffic areas.',
        },
        {
          title: 'Support Dynamic Usage-Based Pricing',
          description:
            'Pay-per-distance, pay-per-minute, or subscription models with surge pricing during peak demand.',
        },
        {
          title: 'Geo-Fence Management',
          description:
            'Define operational zones, parking areas, and restricted zones with automated compliance enforcement.',
        },
        {
          title: 'Sustainability Reporting',
          description:
            'Track emissions saved, energy consumed, and environmental impact metrics for ESG reporting.',
        },
      ]}
      intelligence={[
        {
          title: 'Charging-Aware Fleet Allocation',
          description:
            'Smart algorithms factor battery levels, charging station locations, and demand forecasts to optimize fleet deployment and prevent service gaps.',
        },
        {
          title: 'Predictive Battery Depletion',
          description:
            'Machine learning predicts battery degradation patterns and remaining useful life to optimize replacement timing and maintenance schedules.',
        },
        {
          title: 'Micro-Mobility Usage Forecasting',
          description:
            'AI analyzes weather, events, traffic patterns, and historical data to predict demand surges and guide dynamic pricing strategies.',
        },
      ]}
      metrics={[
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Executives rely on clarity. RentWorksPlus+ provides real-time insights across revenue, fleet performance, and market demand so leaders can make informed, data-driven decisions.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          title: 'Monitor Daily Revenue in One Screen',
          description:
            'Real-time revenue dashboard showing bookings, payments, and profitability across all revenue streams.',
        },
        {
          title: 'Identify Underperforming Units Quickly',
          description:
            'Automated analysis highlights vehicles with low utilization or negative margins for immediate action.',
        },
        {
          title: 'Forecast Fleet Investment Needs',
          description:
            'Predictive models recommend optimal fleet size, composition, and acquisition timing based on demand trends.',
        },
        {
          title: 'Compare Branch Performance',
          description:
            'Side-by-side metrics showing revenue, costs, and profitability across locations with best practice identification.',
        },
        {
          title: 'Market Opportunity Analysis',
          description:
            'Identify untapped customer segments, underserved markets, and expansion opportunities.',
        },
        {
          title: 'Strategic Planning Tools',
          description:
            'Scenario modeling for fleet expansion, pricing changes, and market entry decisions.',
        },
      ]}
      intelligence={[
        {
          ...
          description:
            'Machine learning analyzes seasonal patterns, local events, and market trends to forecast demand with 95%+ accuracy for strategic capacity planning.',
        },
        {
          title: 'Revenue Optimization Modeling',
          description:
            'Advanced algorithms test pricing scenarios and fleet mix strategies to maximize revenue and profitability across customer segments.',
        },
        {
          title: 'Deep KPI Analytics',
          description:
            'Comprehensive business intelligence with leading and lagging indicators, trend analysis, and automated insight generation for strategic decision-making.',
        },
      ]}
      metrics={[
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Fleet managers juggle readiness, maintenance, and utilization. RentWorksPlus+ gives them the intelligence and automation needed to maintain high-performing fleets.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          title: 'Schedule Service Based on Mileage',
          description:
            'Automated maintenance scheduling triggers work orders when vehicles reach service intervals or inspection dates.',
        },
        {
          title: 'Assign Vehicles Instantly',
          description:
            'Visual fleet board shows available vehicles with drag-and-drop assignment to reservations and service bays.',
        },
        {
          title: 'Document Condition in the Field',
          description:
            'Mobile app allows operations staff to capture photos, notes, and damage reports from any location.',
        },
        {
          title: 'Move Units Based on Peak Demand',
          description:
            'AI recommends inter-branch transfers to balance inventory and maximize utilization during demand surges.',
        },
        {
          title: 'Track Service Vendor Performance',
          description:
            'Monitor turnaround times, costs, and quality ratings for maintenance and detailing vendors.',
        },
        {
          title: 'Optimize Cleaning and Prep Workflows',
          description:
            'Task management system coordinates detailing, inspections, and service readiness processes.',
        },
      ]}
      intelligence={[
        {
          ...
          description:
            'Computer vision analyzes vehicle photos to detect damage, wear patterns, and cleanliness issues, automatically prioritizing maintenance needs.',
        },
        {
          title: 'Utilization Heatmaps',
          description:
            'Visual analytics show which vehicles, classes, and locations drive profitability, guiding fleet composition and deployment strategies.',
        },
        {
          title: 'Maintenance Forecasting',
          description:
            'Predictive models estimate upcoming service costs and timing based on usage patterns, enabling proactive budget planning and vendor scheduling.',
        },
      ]}
      metrics={[
  ...
  return (
    <SolutionPageTemplate
      hero={{
        ...
        subtitle:
          'Frontline agents need speed and simplicity. RentWorksPlus+ empowers them with fast reservations, instant payments, digital signatures, and AI-powered support.',
        ctaText: 'Book a Demo',
      ...
      useCases={[
        {
          title: 'Complete a Reservation in Under 60 Seconds',
          description:
            'Streamlined check-out flow with smart defaults and one-click insurance and add-on selections.',
        },
        {
          title: 'Send Instant Payment Requests',
          description:
            'Text or email payment links to customers for deposits, balances, or damage charges with instant processing.',
        },
        {
          title: 'Capture Photos Directly from Mobile',
          description:
            'Document vehicle condition with timestamped photos synced automatically to customer records and contracts.',
        },
        {
          title: 'Access Customer Rental History',
          description:
            'View previous rentals, payment methods, insurance choices, and notes to personalize service.',
        },
        {
          title: 'AI-Powered Upsell Recommendations',
          description:
            'Smart suggestions for insurance, vehicle upgrades, or add-ons based on customer profile and rental type.',
        },
        {
          title: 'Handle Walk-In Customers Efficiently',
          description:
            'Quick availability check, pricing, and immediate vehicle assignment without complex workflows.',
        },
      ]}
      intelligence={[
        {
          title: 'Alexa AI Operator for Overflow Calls',
          description:
            'Conversational AI handles routine inquiries, availability checks, and booking modifications, freeing staff for complex customer needs.',
        },
        {
          title: 'Upsell Recommendation Engine',
          description:
            'Machine learning analyzes customer behavior and rental patterns to suggest relevant add-ons with highest conversion probability.',
        },
        {
          title: 'Customer Insight Summaries',
          description:
            'AI generates concise customer profiles highlighting preferences, value, loyalty status, and satisfaction indicators for personalized service.',
        },
      ]}
      metrics={[
...
export function CarRentalAgenciesPage() {
  return (
    <SimplePage
      title="Solutions for Car Rental Agencies"
      description="Complete solutions for daily rental operations, fleet management, and customer service excellence."
      backLink="/"
    />
  );
}
...
export function EquipmentRentalPage() {
  return (
    <SimplePage
      ...
      description="Specialized tools for construction equipment, heavy machinery, and industrial tool rental operations."
      backLink="/"
    />
  );
}
...
export function DealershipPage() {
  return (
    <SimplePage
      ...
      description="Streamlined loaner vehicle management for automotive dealerships and service centers."
      backLink="/"
    />
  );
}
...
export function FinancePage() {
  return (
    <SimplePage
      title="Solutions for Finance & Accounting"
      description="Payment processing, financial reporting, and accounting integration tools."
      backLink="/"
    />
  );
}
...
export function ITPage() {
  return (
    <SimplePage
      title="Solutions for IT & Digital Transformation"
      description="API access, integrations, and technical tools for digital transformation initiatives."
      backLink="/"
    />
  );
}
  ...
  const featuredArticles = [
    {
      ...
      readTime: '6 min read',
      excerpt:
        'Discover how predictive AI models help rental operators optimize pricing, fleet allocation, and maintenance scheduling for maximum profitability.',
    ...
    },
    {
      ...
      readTime: '8 min read',
      excerpt:
        'Learn proven strategies to increase vehicle utilization rates, reduce idle time, and maximize ROI across your entire rental fleet.',
    ...
    },
    {
      ...
      readTime: '7 min read',
      excerpt:
        'Essential insights for rental operators entering the electric vehicle market, from battery health monitoring to customer charging education.',
    ...
    },
    {
      ...
      readTime: '5 min read',
      excerpt:
        'Airport and downtown locations share their workflows for processing 50+ check-ins per hour with zero customer friction.',
    ...
    },
    {
      ...
      readTime: '6 min read',
      excerpt:
        'How AI analyzes vehicle telemetry, usage patterns, and maintenance history to predict failures weeks in advance.',
    ...
    },
    {
      ...
      readTime: '9 min read',
      excerpt:
        'Market analysis of truck and van rental demand, pricing strategies, and technology adoption rates across commercial operators.',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p
            className="text-lg text-gray-300 max-w-3xl opacity-0 animate-fade-in-left"
            style={{ animationDelay: '0.2s' }}
          >
            Stay ahead with expert analysis, operational best practices, and data-driven strategies
            from the rental industry's leading innovators.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-gradient-to-br from-[#081E32] to-[#007A55] text-white rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Subscribe to receive weekly updates on rental automation, AI trends, and operational
            best practices.
          </p>
  ...
  const guides = [
    {
      ...
      description:
        '40-page comprehensive guide covering centralized fleet management, branch performance optimization, and AI-powered transfer recommendations for franchise operators.',
      topics: [
        'Fleet Distribution',
        'Branch Analytics',
        'Transfer Automation',
    ...
    },
    {
      ...
      description:
        'Step-by-step methodology for implementing dynamic pricing using demand forecasting, competitor analysis, and seasonal trend prediction.',
      topics: [
        'Demand Prediction',
        'Dynamic Pricing',
    ...
    },
    {
      ...
      description:
        'Comprehensive guide to reducing downtime and repair costs through AI-powered predictive maintenance, service scheduling, and condition monitoring.',
      topics: [
    ...
    },
    {
      ...
      description:
        'Best practices for managing corporate accounts, recurring billing, contract lifecycle automation, and renewal scoring systems.',
      topics: [
        'Contract Automation',
        'Recurring Billing',
        'Renewal Prediction',
    ...
    },
    {
      ...
      description:
        'Proven workflows for reducing check-in times, improving customer satisfaction scores, and implementing self-service options for modern renters.',
      topics: [
        'Check-In Workflows',
        'Self-Service',
    ...
    },
    {
      ...
      description:
        'Essential playbook for electric vehicle fleet operators covering battery management, charging infrastructure, range optimization, and customer education.',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p
            ...
            style={{ animationDelay: '0.2s' }}
          >
            Comprehensive operational playbooks created by industry experts to help you implement
            best practices, optimize workflows, and scale your rental business efficiently.
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#F4F5F7] py-20">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-3xl font-bold text-[#081E32] mb-12 text-center">
            Why Download Our Playbooks?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Battle-tested strategies used by top-performing rental operators across 12+
                countries.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Step-by-step implementation guidance with KPIs and success metrics for every
                strategy.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Regularly refreshed with the latest AI capabilities, market trends, and best
                practices.
              </p>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-gradient-to-br from-[#081E32] to-[#007A55] text-white rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Our team of rental operations experts can help you implement these strategies tailored
  ...
  const templates = [
    {
      ...
      items: [
        {
          name: 'Pre-Rental Vehicle Inspection Form',
          format: 'PDF + Excel',
          icon: <Car className="w-5 h-5" />,
        },
        {
          name: 'Post-Rental Damage Documentation Checklist',
          format: 'PDF',
          icon: <Car className="w-5 h-5" />,
        },
        {
          name: 'Photo-Based Inspection Template (Mobile-Ready)',
          format: 'PDF',
          icon: <Car className="w-5 h-5" />,
        },
      ],
    },
    {
      ...
      items: [
        {
          name: 'Daily Fleet Status Report Template',
          format: 'Excel',
          icon: <Wrench className="w-5 h-5" />,
        },
        {
          name: 'Check-In/Check-Out Process Checklist',
          format: 'PDF',
          icon: <Check className="w-5 h-5" />,
        },
        {
          name: 'Multi-Location Transfer Request Form',
          format: 'Excel + PDF',
          icon: <Building2 className="w-5 h-5" />,
        },
        {
          name: 'Fleet Maintenance Schedule Template',
          format: 'Excel',
          icon: <Wrench className="w-5 h-5" />,
        },
      ],
    },
    {
      ...
      items: [
        {
          name: 'Rental Agreement Template (Customizable)',
          format: 'Word + PDF',
          icon: <FileText className="w-5 h-5" />,
        },
        {
          name: 'Corporate Account Setup Checklist',
          format: 'PDF',
    ...
    },
    {
      ...
      items: [
        {
          name: 'Monthly Revenue & Utilization Dashboard',
          format: 'Excel',
          icon: <TrendingUp className="w-5 h-5" />,
        },
        {
          name: 'Payment Reconciliation Worksheet',
          format: 'Excel',
          icon: <Check className="w-5 h-5" />,
        },
        {
          name: 'Branch Performance Comparison Template',
          format: 'Excel',
          icon: <Building2 className="w-5 h-5" />,
        },
      ],
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p
            ...
            style={{ animationDelay: '0.2s' }}
          >
            Ready-to-use forms, checklists, and spreadsheet templates designed specifically for
            rental operations. Download, customize, and implement immediately.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-gradient-to-br from-[#081E32] to-[#007A55] text-white rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            RentWorksPlus+ includes all these templates built directly into the platform with
            auto-fill, digital signatures, and instant delivery.
          </p>
          <button className="px-8 py-4 bg-white text-[#007A55] font-semibold rounded-xl hover:bg-gray-100 transition-colors">
      ...
      highlights: [
        {
          ...
          description:
            'New machine learning models predict rental demand 30-90 days ahead with 89% accuracy, enabling proactive pricing and fleet positioning.',
          icon: <TrendingUp className="w-5 h-5" />,
        },
        {
          title: 'Multi-Currency Support',
          description:
            'Full support for 45+ currencies with automatic exchange rate updates and multi-currency financial reporting.',
          icon: <Check className="w-5 h-5" />,
        },
        {
          title: 'Advanced Fleet Transfer Engine',
          description:
            'AI suggests optimal vehicle transfers between locations based on demand prediction, utilization gaps, and transportation costs.',
          icon: <Car className="w-5 h-5" />,
        },
      ],
    },
      ...
      highlights: [
        {
          ...
          description:
            'Real-time battery condition tracking with degradation alerts, charging cycle optimization, and range prediction.',
          icon: <Zap className="w-5 h-5" />,
        },
        {
          title: 'Bulk SMS Notifications',
          description:
            'Send reservation confirmations, pickup reminders, and return notifications via SMS to thousands of customers simultaneously.',
          icon: <Check className="w-5 h-5" />,
        },
      ],
    },
      ...
      highlights: [
        {
          ...
          description:
            'Voice-powered rental assistant processes reservations, answers customer questions, and handles routine inquiries 24/7.',
          icon: <Users className="w-5 h-5" />,
        },
        {
          title: 'Mobile App Offline Mode',
          description:
            'Complete check-in/out workflows work without internet connection and auto-sync when connectivity returns.',
          icon: <Check className="w-5 h-5" />,
        },
        {
          title: 'Corporate Contract Lifecycle',
          description:
            'Automated contract renewal scoring, usage tracking, and predictive analytics for long-term corporate accounts.',
          icon: <Briefcase className="w-5 h-5" />,
        },
      ],
    },
      ...
      highlights: [
        {
          ...
          description:
            'Optimized queries and caching reduce main dashboard load time from 2.1s to 0.8s average.',
          icon: <TrendingUp className="w-5 h-5" />,
        },
        {
          title: 'API Rate Limit Increase',
          description:
            'Increased API rate limits from 1000/hour to 5000/hour for enterprise accounts.',
          icon: <Check className="w-5 h-5" />,
        },
      ],
    },
      ...
      highlights: [
        {
          ...
          description:
            'AI analyzes mileage, usage patterns, and service history to predict maintenance needs 2-4 weeks in advance.',
          icon: <Wrench className="w-5 h-5" />,
        },
        {
          title: 'Smart Damage Detection',
          description:
            'Computer vision automatically compares pre/post rental photos to identify new damage with 94% accuracy.',
          icon: <Car className="w-5 h-5" />,
        },
      ],
    },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p
            ...
            style={{ animationDelay: '0.2s' }}
          >
            Track every improvement to RentWorksPlus+ with detailed release notes, feature launches,
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-gradient-to-br from-[#081E32] to-[#007A55] text-white rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Subscribe to receive instant notifications when new features launch, updates deploy, or
  ...
  const upcomingWebinars = [
    {
      ...
      description:
        'Learn how top rental operators use machine learning to optimize fleet distribution, pricing, and maintenance scheduling.',
    ...
    },
    {
      ...
      description:
        'Deep dive into centralized management, branch performance analytics, and AI-powered fleet transfer recommendations.',
    ...
    },
    {
      ...
      description:
        'Essential strategies for managing electric vehicle fleets including battery monitoring, charging optimization, and range prediction.',
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p
            ...
            style={{ animationDelay: '0.2s' }}
          >
            Join our expert-led training sessions, live demos, and industry discussions to master
            rental operations and AI-powered automation.
          </p>
        </div>
      </div>
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-[#081E32] mt-3 mb-2">
                        {webinar.title}
                      </h3>
  ...
  const featureCards = [
    {
      ...
      description:
        'Eliminate the cost and complexity of multiple vendors with a unified system covering fleet, reservations, pricing, payments & maintenance.',
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: 'Trusted by Operators Worldwide',
      description:
        'Used by rental companies in 40+ countries, processing 2M+ rentals with industry-leading retention.',
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: '24/7 Rental-Focused Support',
      description:
        'Get real-time help from specialists who understand mobility, fleets, and rental operations.',
    },
  ];
  ...
  const benefitCards = [
    {
      ...
      description:
        'Automate reservations, pricing, maintenance, and check-in/out workflows with intelligent tools built for car rental operations.',
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: 'Fleet Intelligence That Drives Revenue',
      description:
        'Monitor utilization, demand, battery/charging (EV), and maintenance needs in real-time — improving profitability per vehicle.',
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: 'Simple, Transparent, Scalable Pricing',
      description:
        'Only pay for what you need — modules scale as your fleet grows across new locations, vehicle types, and rental programs.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-12">
            ...
            <div>
              ...
              <p
                className="text-xl text-gray-600 mb-12 leading-relaxed slide-blur"
                style={{ animationDelay: '0.1s' }}
              >
                Our pricing scales with your fleet size, locations, and operational needs — no
                paying for features you don't use. Tell us about your rental operation, and we'll
                prepare a personalized quote that includes the exact modules and capabilities your
                business requires.
              </p>

              <h2 className="text-2xl font-bold text-[#081E32] mb-8">
                What makes RentWorksPlus+ the smart choice?
              </h2>
            ...
            <div className="lg:sticky lg:top-24 h-fit">
              <div
                className="slide-blur bg-white rounded-2xl p-8 shadow-xl border border-gray-200"
                style={{ animationDelay: '0.2s' }}
              >
                {submitSuccess ? (
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        <label className="block text-sm font-semibold text-[#081E32] mb-2">
                          First Name
                        </label>
                        <input
                          type="text"
                    ...
                    <p className="text-xs text-gray-500 mb-6">
                      By clicking 'Get Pricing,' you agree to our Terms of Service and Privacy
                      Policy.
                    </p>
      ...
      <section className="py-20 px-8 bg-[#F4F5F7]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#081E32] mb-4 glow-pulse">
              Why Rental Operators Choose RentWorksPlus+
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Trusted by operators worldwide for intelligent, scalable, and transparent rental
              management.
            </p>
          </div>
      ...
      <section className="py-12 px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xl text-gray-600 leading-relaxed">
            <span className="font-semibold text-[#081E32]">No setup fees.</span>{' '}
            <span className="font-semibold text-[#081E32]">No hidden charges.</span> Flexible
      ...
      <section className="py-20 px-8 bg-gradient-to-br from-[#081E32] to-[#0a2740] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 glow-pulse">
            Ready to See RentWorksPlus+ in Action?
          </h2>
          <p className="text-xl text-gray-300 mb-10 leading-relaxed">
            Get a custom quote and tailored walkthrough for your operations. See exactly how
            RentWorksPlus+ can transform your rental business.
          </p>
...
export function AboutPage() {
  ...
  const milestones = [
    {
      year: '2010',
      title: 'Founded',
      description: 'Started with a vision to modernize rental operations',
    },
    {
      year: '2015',
      title: 'Cloud Platform Launch',
      description: 'Transitioned from desktop to cloud-based SaaS solution',
    },
    {
      year: '2018',
      title: 'AI Integration',
      description: 'Introduced machine learning for demand forecasting',
    },
    {
      year: '2021',
      title: 'Global Expansion',
      description: 'Reached 25+ countries with multilingual support',
    },
    {
      year: '2023',
      title: 'Alexa AI Release',
      description: 'Launched conversational AI operator assistant',
    },
    {
      year: '2025',
      title: '500+ Customers',
      description: 'Processing 2M+ rentals monthly across 40+ countries',
    },
  ];
  ...
  const values = [
    {
      ...
      title: 'Innovation',
      description:
        'Continuously pushing boundaries with AI-driven automation and intelligent workflows',
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: 'Simplicity',
      description:
        'Complex problems solved through intuitive design and frictionless user experiences',
    },
    {
      icon: <Check className="w-6 h-6" />,
      title: 'Trust',
      description:
        'Building lasting relationships through transparency, reliability, and 99.9% uptime',
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: 'Intelligence',
      description:
        'Transforming data into actionable insights that drive better business decisions',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl leading-relaxed">
            RentWorksPlus+ is built on decades of rental experience combined with next-generation AI
            innovation. Our mission is to transform mobility businesses with automation, insight,
            and simplicity.
          </p>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <h2 className="text-4xl font-bold text-[#081E32] mb-12 text-center glow-pulse">
          Our Evolution
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="slide-blur" style={{ animationDelay: '0.1s' }}>
            <div className="p-8 bg-[#F4F5F7] rounded-2xl hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Manual spreadsheets and disconnected systems → intelligent automation
              </p>
            </div>
          </div>
          <div className="slide-blur" style={{ animationDelay: '0.2s' }}>
            <div className="p-8 bg-[#F4F5F7] rounded-2xl hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Manual workflows → predictive intelligence and proactive recommendations
              </p>
            </div>
          </div>
          <div className="slide-blur" style={{ animationDelay: '0.3s' }}>
            <div className="p-8 bg-[#F4F5F7] rounded-2xl hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Isolated tools → comprehensive platform with seamless integrations
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xl text-gray-700 leading-relaxed">
                    "To empower mobility businesses with intelligent software that simplifies
                    operations and converts data into insights."
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            <div key={index} className="slide-blur" style={{ animationDelay: `${index * 0.12}s` }}>
      ...
      <div className="bg-[#F4F5F7] py-20">
        <div className="max-w-5xl mx-auto px-8">
          <h2 className="text-4xl font-bold text-[#081E32] mb-16 text-center glow-pulse">
            Major Milestones
          </h2>
          <div className="relative">
      ...
      <div className="bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white py-20">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-8">
            Our team brings decades of hands-on rental experience combined with cutting-edge
            technology expertise. We don't just build software—we solve real operational challenges
            that we've lived ourselves.
          </p>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl leading-relaxed">
            RentWorksPlus+ integrates seamlessly with the tools and platforms that modern mobility
            businesses rely on—from payments and telematics to CRM, mapping, and ERP systems.
          </p>
          <button className="mt-10 px-10 py-4 bg-[#007A55] text-white font-semibold rounded-xl magnetic-cta">
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {integrationBenefits.map((benefit, index) => (
            <div key={index} className="slide-blur" style={{ animationDelay: `${index * 0.1}s` }}>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="slide-blur">
            <h2 className="text-4xl font-bold text-[#081E32] mb-6 glow-pulse">
              API-First Architecture
            </h2>
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              RentWorksPlus+ is built on a modern, RESTful API that gives you complete programmatic
      ...
      <div className="bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white py-20">
        <div className="max-w-6xl mx-auto px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Our integration library expands monthly with new partners and protocols, ensuring you
            can connect RentWorksPlus+ to virtually any business system.
          </p>
          <button className="px-10 py-4 bg-[#007A55] text-white font-semibold rounded-xl magnetic-cta">
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-[#F4F5F7] rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Join our growing ecosystem and make your solution available to hundreds of rental
            operators worldwide.
          </p>
          <button className="px-10 py-4 bg-[#007A55] text-white font-semibold rounded-xl magnetic-cta">
            Partner With Us
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#081E32] via-[#0a2640] to-[#081E32] text-white py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl leading-relaxed">
            We're hiring innovators, creators, and problem-solvers who are passionate about
            transforming the global car rental industry with AI-driven solutions.
          </p>
          <button className="mt-10 px-10 py-4 bg-[#007A55] text-white font-semibold rounded-xl magnetic-cta">
            Explore Open Roles
          </button>
            ...
            <div className="slide-blur" style={{ animationDelay: '0.6s' }}>
              <div className="bg-white rounded-2xl p-8 spotlight-card cursor-pointer h-full border-2 border-[#007A55]">
                ...
                <p className="text-gray-600 mb-6">
                  We're always looking for exceptional talent. Send us your resume and tell us why
          ...
          {[
            {
              name: 'Sarah Chen',
              role: 'VP of Product',
              quote: "We're solving real problems for an industry that's ready for transformation.",
            },
            {
              name: 'Marcus Johnson',
              role: 'Head of Engineering',
              quote: 'Our tech stack combines cutting-edge AI with battle-tested reliability.',
            },
            {
              name: 'Ana Rodriguez',
              role: 'Director of Customer Success',
              quote: 'Seeing our customers succeed is what drives everything we do.',
            },
          ].map((member, index) => (
            <div key={index} className="slide-blur" style={{ animationDelay: `${index * 0.15}s` }}>
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-white rounded-3xl p-12 border border-gray-200 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            We're committed to building a diverse team that reflects the global customers we serve.
            All qualified applicants receive equal consideration regardless of race, color,
            religion, gender, sexual orientation, national origin, disability, or veteran status.
          </p>
        </div>
      </div>
...
export function PressPage() {
  ...
  const pressReleases = [
    {
      ...
      excerpt:
        'New intelligent pricing algorithm increases revenue by up to 22% through real-time market analysis and demand forecasting.',
      link: '#',
    },
    {
      ...
      excerpt:
        'Advanced conversational AI responds to customer questions, processes bookings, and provides instant support around the clock.',
      link: '#',
    },
    {
      date: 'June 20, 2024',
      ...
      excerpt:
        'Global expansion brings intelligent rental operations platform to Asia-Pacific, EMEA, and Latin American markets.',
      link: '#',
    },
  ];
  ...
  const mediaEssentials = [
    ...
    },
    {
      icon: <Award className="w-6 h-6" />,
      label: 'Logos & Icons',
      description: 'SVG, PNG, and vector formats',
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="relative pt-32 pb-20 px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-[#007A55] font-semibold text-lg tracking-wide">
              PRESS & MEDIA
            </span>
          </div>
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl leading-relaxed">
            Find press releases, brand guidelines, leadership quotes, and official media assets for
            coverage, partnerships, and publications.
          </p>
              ...
              >
                <div className="flex items-start justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <a
                      href={release.link}
                      className="text-[#007A55] font-semibold flex items-center gap-2 hover:underline"
                    >
                      Read full release
                      <ExternalLink className="w-4 h-4" />
                    </a>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {latestCoverage.map((article, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#081E32] mb-3 leading-snug">
                  {article.title}
                </h3>
      ...
      <section className="py-20 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div
              className="slide-blur bg-white rounded-xl p-8 shadow-md text-center"
            ...
            >
              ...
              <a
                href="mailto:press@rentworksplus.com"
                className="text-[#007A55] font-semibold hover:underline"
              >
            ...
            >
              ...
              <a
                href="mailto:partnerships@rentworksplus.com"
                className="text-[#007A55] font-semibold hover:underline"
              >
      ...
      <section className="py-20 px-8 bg-gradient-to-br from-[#081E32] to-[#0a2740] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-10 leading-relaxed">
            Everything you need in one ZIP file - logos, screenshots, executive bios, brand
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-slide-diagonal">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Your complete knowledge base for everything RentWorksPlus+. Search articles, how-tos,
              feature explanations, and operational best practices.
            </p>
      ...
      <section className="py-12 bg-[#F4F5F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-diagonal-delay-1">
          <p className="text-lg text-gray-700 leading-relaxed">
            Designed for rental teams of all sizes, our Help Center offers step-by-step guidance for
            using RentWorksPlus+ across reservations, fleet operations, payments, reporting, and
            more. Everything is organized, searchable, and constantly updated.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-[#081E32] text-3xl font-bold mb-3 pulse-line-divider">
            Popular Categories
          </h2>
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            {[
              ...
              {
                icon: <Calendar className="w-6 h-6" />,
                title: 'Reservations & Agreements',
                articles: '32 articles',
              },
              {
                icon: <Car className="w-6 h-6" />,
                title: 'Fleet Management & Maintenance',
              ...
              >
                <div
                  className={`w-14 h-14 rounded-lg bg-[#007A55]/10 flex items-center justify-center text-[#007A55] mb-4 animate-micro-bounce-delay-${Math.min(index % 3, 2)}`}
                >
                  {category.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12">
            {[
              ...
              {
                title: 'Capturing Photos & Digital Signatures from Any Device',
                time: '4 min read',
              },
            ].map((article, index) => (
              <div
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-slide-diagonal">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Deep feature documentation for teams who need precise, detailed explanations of how
              the RentWorksPlus+ platform works.
            </p>
            <button className="lift-ease-cta bg-[#007A55] text-white px-8 py-4 rounded-xl hover:bg-[#006644]">
      ...
      <section className="py-12 bg-[#F4F5F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-diagonal-delay-1">
          <p className="text-lg text-gray-700 leading-relaxed">
            From configuration steps to operational flows, the RentWorksPlus+ Documentation Hub
            provides clarity on every feature. Clear diagrams, walkthroughs, rules, and admin-level
            details help your team stay productive and informed.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12">
            {[
              {
                icon: <Car className="w-6 h-6" />,
                title: 'Reservation Lifecycle Documentation',
                description:
                  'Complete guide to reservations, contracts, pricing, and customer workflows.',
                pages: '45 pages',
              },
              {
                icon: <Wrench className="w-6 h-6" />,
                title: 'Fleet Lifecycle Documentation',
                description:
                  'Vehicle tracking, inspection protocols, maintenance schedules, and lifecycle management.',
                pages: '32 pages',
              },
              {
                icon: <TrendingUp className="w-6 h-6" />,
                ...
                description:
                  'Custom reports, KPI dashboards, utilization metrics, and revenue intelligence.',
                pages: '28 pages',
              },
              {
                icon: <Settings className="w-6 h-6" />,
                title: 'Payments & Billing Workflows',
                description: 'User permissions, branch setup, rate structures, and admin settings.',
                pages: '38 pages',
              },
              {
                icon: <CreditCard className="w-6 h-6" />,
                ...
                description:
                  'Gateway integration, refund handling, deposit management, and billing cycles.',
                pages: '22 pages',
              },
              {
                ...
                description:
                  'Mobile features, responsive design, offline mode, and customer portals.',
                pages: '19 pages',
              },
            ].map((section, index) => (
              <div
      ...
      <section className="py-16 bg-[#F4F5F7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-[#081E32] text-3xl font-bold mb-12 text-center">
            ...
            {[
              {
                ...
                label: 'Written for rental operators',
                desc: 'Industry-specific guidance',
              },
              {
                icon: <BookOpen className="w-6 h-6" />,
                label: 'Clear diagrams for workflows',
                desc: 'Visual learning aids',
              },
              {
                icon: <Download className="w-6 h-6" />,
                label: 'Constantly updated',
                desc: 'Platform changes reflected',
              },
              {
                icon: <RefreshCw className="w-6 h-6" />,
                label: 'Matches the real UI exactly',
                desc: 'No confusion',
              },
            ].map((strength, index) => (
              <div key={index} className="text-center animate-slide-diagonal-delay-2">
                <div
                  className={`w-16 h-16 rounded-full bg-[#007A55] flex items-center justify-center text-white mb-4 mx-auto animate-micro-bounce-delay-${index % 3}`}
                >
                  {strength.icon}
                </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-slide-diagonal">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Build integrations, apps, partner workflows, or mobile tools powered by RentWorksPlus+
              using our secure, modern API platform.
            </p>
            <button className="lift-ease-cta bg-[#007A55] text-white px-8 py-4 rounded-xl hover:bg-[#006644]">
              Get API Key
            </button>
      ...
      <section className="py-12 bg-[#F4F5F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-diagonal-delay-1">
          <p className="text-lg text-gray-700 leading-relaxed">
            Our API Docs provide clear, developer-ready references for authentication, endpoints,
            payloads, and webhook events. Developers can explore examples, try live calls, and build
            quickly using our sandbox environment.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {[
              {
                method: 'POST',
                endpoint: 'Authentication (OAuth)',
                desc: 'Secure token-based auth',
              },
            ...
            {[
              {
                ...
                desc: 'Modern API design',
              },
              {
                icon: <Zap className="w-6 h-6" />,
                title: 'Sandbox for testing',
                desc: 'Safe development environment',
              },
              {
                icon: <Code className="w-6 h-6" />,
                title: 'High-performance design',
                desc: 'Low-latency responses',
              },
              {
                icon: <FileText className="w-6 h-6" />,
                title: '100+ integration use cases',
                desc: 'Proven at scale',
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="text-center bg-white rounded-xl p-6 border border-gray-200 animate-slide-diagonal-delay-2"
              >
                <div
                  className={`w-16 h-16 rounded-full bg-[#007A55]/10 flex items-center justify-center text-[#007A55] mb-4 mx-auto animate-micro-bounce-delay-${index % 3}`}
                >
                  {feature.icon}
                </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-slide-diagonal">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Get your entire team fully trained — fast. Personalized onboarding ensures you launch
              RentWorksPlus+ with confidence and operational excellence.
            </p>
            <button className="lift-ease-cta bg-[#007A55] text-white px-8 py-4 rounded-xl hover:bg-[#006644]">
              Start Training
            </button>
      ...
      <section className="py-12 bg-[#F4F5F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-diagonal-delay-1">
          <p className="text-lg text-gray-700 leading-relaxed">
            Our onboarding specialists work directly with your team to configure your fleet,
            pricing, workflows, and integrations. With structured training programs, your staff
            becomes proficient on day one.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Fast deployment',
              },
              {
                icon: <TrendingUp className="w-6 h-6" />,
                title: 'Reduced ramp-up time',
                desc: 'Quick proficiency',
              },
              {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-slide-diagonal">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Get help from real rental technology specialists — 24/7. Choose the best channel for
              your team.
            </p>
            <button className="lift-ease-cta bg-[#007A55] text-white px-8 py-4 rounded-xl hover:bg-[#006644]">
              Open Support Ticket
      ...
      <section className="py-12 bg-[#F4F5F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-diagonal-delay-1">
          <p className="text-lg text-gray-700 leading-relaxed">
            Our support team understands rental operations deeply. Whether you need help with setup,
            daily workflows, API integration, or billing — we're here around the clock.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Self-service articles and guides',
              },
              {
                icon: <Lightbulb className="w-6 h-6" />,
                title: 'Feature Requests Portal',
                desc: 'Submit and vote on new features',
              },
              {
                icon: <Calendar className="w-6 h-6" />,
                title: 'Scheduled Training',
                desc: 'Book personalized sessions',
              },
            ].map((extra, index) => (
              <div
                key={index}
              ...
              >
                <div
                  className={`w-16 h-16 rounded-full bg-[#007A55]/10 flex items-center justify-center text-[#007A55] mb-4 mx-auto animate-micro-bounce-delay-${index}`}
                >
                  {extra.icon}
                </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-[#081E32] to-[#0a2640] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-slide-diagonal">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Check live system performance, uptime history, scheduled maintenance, and real-time
              service alerts.
            </p>
            <div className="flex items-center gap-3">
      ...
      <section className="py-12 bg-[#F4F5F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-diagonal-delay-1">
          <p className="text-lg text-gray-700 leading-relaxed">
            RentWorksPlus+ delivers enterprise-grade reliability with global hosting infrastructure.
            Our transparent status page keeps your team informed of uptime, maintenance windows, or
            disruptions.
          </p>
        </div>
      </section>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-lg bg-green-100 flex items-center justify-center animate-micro-bounce-delay-${Math.min(index % 3, 2)}`}
                  >
